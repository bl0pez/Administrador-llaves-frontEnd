...
import { BorrowedKey, Key } from '../interfaces';
...
//Tipado de llaves
type Keys = BorrowedKey[] | Key[];

//Filtrado de llaves
const keyFiltrado = (items: Key[], search: String) => {
...
const borrowedKeyFiltrado = (items: BorrowedKey[], search: String) => {
    return items.filter((item) => (
